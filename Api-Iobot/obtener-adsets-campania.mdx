...
Retorna los adsets (conjuntos de anuncios) de una campaña de Meta Ads, incluyendo los anuncios individuales, sus métricas de gasto y la información de la campaña padre.
...
<RequestExample>
```bash
curl -X GET "https://beta.api-iobot-desarrollo.com/empresas/campaigns/1/120200000000001?datePreset=last_7d&start=2026-04-25T00:00:00Z&end=2026-05-02T00:00:00Z&token=META_TOKEN" \
