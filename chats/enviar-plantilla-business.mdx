...
<ParamField body="parameters" type="array">
  Lista de parámetros dinámicos para inyectar en los componentes de la plantilla. Sigue el formato de componentes de Meta. Por defecto es un arreglo vacío.
