...
<ParamField body="paramMapping" type="object">
  ...
  El mapeo es por nombre de campo, no por posición. `{{1}}` resolverá al campo que especifiques en `"1"` — puede ser `nombre`, `numero`, o cualquier campo extra. Ningún campo tiene tratamiento especial.
